...
jQuery(document).ready(function($){
		...
		****************************/
		...
		$('.color-picker').closest('.control-group').addClass('pickerblock').hide();
        ...
        $('#colors_params .preset-contents').on('click', function(event){
            ...
            $('#colors_params .ytcolor-wrap').closest('.control-group').hide();
			
            $('#colors_params .ytcolor-wrap').find('[class^="'+$(this).data('preset')+'"]').closest('.control-group').show();
        });
