...
// Get param template
$hideComponentHomePage      = $yt->getParam('hideComponentHomePage');
...
$loadingpage				=$yt->getParam('loadingpage');
...
$comingsoon_mode            = $yt->getParam('comingsoon_mode');
...
// None Responsive
if($layoutType =='fixed') $yt->ytStyleSheet('asset/bootstrap/css/non-responsive.css');
...
// KeepMenu
if($keepmenu && $layout =='default' && !$comingsoon ) $doc->addScript($yt->templateurl().'js/keepmenu.js');
