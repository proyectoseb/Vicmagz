			...
			<div class="el-inner">
				...
				<div class="el-info-contact">
					...
					<div class="info-address cf">
						...
						<span class="info-label" data-label="<?php echo JText::_('ADD_LABEL') ?>"><br /> <span><?php echo $address; ?></span></span>
					</div>
					<?php }
					...
					<div class="info-mobie cf">
						...
						<span class="info-label" data-label="<?php echo JText::_('TEL_FAX_LABEL') ?>"> <br /><span><?php echo $mobile . ' - ' . $fax ; ?></span></span>
					</div>
					<?php }
					...
					<div class="info-mail cf">
						...
						<span class="info-label" data-label="<?php echo JText::_('MAIL_LABEL') ?>"><br /><a href="mailto:<?php echo $mail_to; ?>"><?php echo $mail_to; ?></a></span>
						
					</div>
					<?php }
					$desc = trim($list->misc);
					if($desc != '' ) ?>	
					<div class="el-desc cf">
						<?php echo $desc; ?>
					</div>
				</div>
			</div>
		...
		<div class="ctajax-element col-md-6 col-sm-6">
			<div class="el-inner cf">
				<div class="el-form cf">
					<h2 class="el-heading"><span><?php echo JText::_('AJAX_CONTACT_FORM');?></span></h2>
					<form class="el-ctajax-form" id="el_ctajax_form" method="post" action="">
						<div class="el-control">
							...
							<input type="text" autocomplete="off"  name="cainput_name" class="el-input" id="cainput_name" placeholder="<?php echo JText::_('NAME_LABEL_CONTACT');?> &#40;required&#41;">
						...
						<div class="el-control ">
							...
							<input autocomplete="off" type="text"  name="cainput_email" class="el-input" id="cainput_email" placeholder="<?php echo JText::_('EMAIL_LABEL_CONTACT');?>&#40;required&#41;">
						...
						<div class="el-control">
							...
							<input type="text" autocomplete="off"  name="cainput_subject" class="el-input" id="cainput_subject" placeholder="<?php echo JText::_('PHONE_CONTACT');?>">
						...
						<div class="el-control">	
							...
							<textarea name="cainput_message" maxlength="1000" class="el-input" id="cainput_message" placeholder="<?php echo JText::_('COMMENT_CONTACT');?>"></textarea>
						...
						<?php } ?>	
						<div class="el-control">
							<input type="submit"  value="<?php echo JText::_('POST_COMMENT'); ?>"  id="cainput_submit">
