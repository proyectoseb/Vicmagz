...
function modChrome_ytmod($module, &$params, &$attribs){ ?>
    <?php
	$module->title = str_replace( array('(', ')'), array('<span class="stylecolortitle">', '</span>'), $module->title );
	...
	<div class="module <?php echo $modclass_sfx ?> " <?php echo ($scrollreveal !='')?  'data-sr="'. $scrollreveal.'"' : '' ; ?>>
	    <?php if ((bool) $module->showtitle) : ?>
		    <h3 class="modtitle"><span class="styletitle"><?php echo $icons; ?><?php echo $module->title; ?></span><?php echo $badge; ?></h3>
	    <?php endif; ?>
