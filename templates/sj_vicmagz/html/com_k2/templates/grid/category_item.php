	...
	<div class="media">
		...
		<div class="catItemImageBlock">
			<span class="catItemImage">
				<a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
					...
					if (!empty( $src)) {								
						$thumb_img = '<img src="'.$src.'" alt="'.$this->item->title.'"style="width:'.$this->item->imageWidth.'px; height:auto;" />';
					} else if ($is_placehold) {					
						$thumb_img = yt_placehold($placehold_size['large'],$this->item->title,$this->item->title);
					}	
					echo $thumb_img;
				?>
		...
		<div class="media-body">
			<div class="catItemHeader">
				...
				<?php endif; ?>
				<span class="catItemDateCreated">
					<span><?php echo str_replace(' ', '</span><span>', JHTML::_('date', $this->item->created , JText::_('d M')));?></span>
				</span>
				...
				<ul class="catItemHeaderFooter">
					...
					<!--<li><i class="fa fa-clock-o"></i><?php echo timeAgo($this->item->created); ?></li>-->
