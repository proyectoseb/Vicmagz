...
<div id="k2Container" class="itemListViewList itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			<div class="row">
				...
				<div class="itemContainer itemContainer<?php echo $lastContainer; ?> col-sm-<?php echo (count($this->leading) == 1) ? 12 : number_format( 12/$this->params->get('num_leading_columns'), 0) ?>">
					<?php
		...
		<div id="itemListPrimary">
			<div class="row">
				...
				<div class="itemContainer itemContainer<?php echo $lastContainer; ?> col-sm-<?php echo (count($this->primary) == 1) ? 12 : number_format(12/$this->params->get('num_primary_columns'), 0); ?>">
					<?php
						// Load category_item.php by default
						$this->item=$item;
						echo $this->loadTemplate('item');
		...
		<div id="itemListSecondary">
			<div class="row">
				...
				<div class="itemContainer itemContainer<?php echo $lastContainer; ?> col-sm-<?php echo (count($this->secondary) == 1) ? 12 : number_format(12/$this->params->get('num_secondary_columns'), 0); ?>">
					<?php
						// Load category_item.php by default
						$this->item=$item;
						echo $this->loadTemplate('item');
