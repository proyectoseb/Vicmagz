...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php //if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
	  ...
	  <div class="itemImageBlock">
		  ...
		  <span class="itemImage">
				<a class="" data-rel="prettyPhoto" rel="{handler: 'image'}"  href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
				<?php 
  ...
  <div class="itemBody">
	  ...
	  <div class="itemExtraFields">
	  	<h3  class="itemBlocktitle"><?php echo JText::_('K2_ADDITIONAL_INFO'); ?></h3>
	  	<ul>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="itemPreviousblock media">
					<a class="itemPrevious pull-left" href="<?php echo $this->item->previousLink; ?>">
			...
			<div class="col-sm-6 <?php echo isset($this->item->previousLink) ? '' : 'pull-right'; ?>">
				<div class="itemNextblock media">
					<a class="itemNext pull-right" href="<?php echo $this->item->nextLink; ?>">
  ...
  <div class="itemAuthorBlock">
	<h3  class="itemBlocktitle"><?php echo JText::_('K2_AUTHOR_ME');?></h3>
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest">
		<h3  class="itemBlocktitle"><?php echo JText::_('K2_LATEST_FROM'); ?> <?php echo $this->item->author->name; ?></h3>
		<ul>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h3  class="itemBlocktitle"><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></h3>
		<div class="row">
			<?php foreach($this->relatedItems as $key=>$item): ?>
			<div class="<?php //echo ($key%2) ? "odd" : "even"; ?> col-sm-<?php echo count($this->relatedItems)<5 ? 12/count($this->relatedItems) : 5 ?>">
				...
				<?php if($this->item->params->get('itemRelatedImageSize')): ?>
					...
					<?php 
						...
						echo yt_placehold($placehold_size['article'],$this->item->title);
					}?>
				<?php endif; ?>
  ...
  <div class="itemVideoBlock">
  	<h3  class="itemBlocktitle"><?php echo JText::_('K2_MEDIA'); ?></h3>
  ...
  <div class="itemImageGallery">
	  <h3  class="itemBlocktitle"><?php echo JText::_('K2_IMAGE_GALLERY'); ?></h3>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemCommentswrapper">
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php //echo ($key%2) ? "odd" : "even"; 
		echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
