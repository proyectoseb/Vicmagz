...
//    $currency = CurrencyDisplay::getInstance();
    ...
    <div class="moduletable <?php echo $class_suffix; ?>">
        ...
        <div id="<?php echo $tag_id;?>"
             class="sj-extra-slider trending msie lt-ie9 <?php echo $cls_btn_page; ?> <?php echo $class_respl; ?> <?php echo $btn_type; ?>" ><![endif]-->
        <!--[if IE 9]>
        <div id="<?php echo $tag_id;?>"
             class="sj-extra-slider trending msie <?php echo $cls_btn_page; ?> <?php echo $class_respl; ?> <?php echo $btn_type; ?>"><![endif]-->
        <!--[if gt IE 9]><!-->
        <div id="<?php echo $tag_id ; ?>"
             class="sj-extra-slider trending <?php echo $cls_btn_page; ?> <?php echo $class_respl; ?>  <?php echo $btn_type; ?>"><!--<![endif]-->
                            ...
                            if($img){
                                ...
                                <div class="item-image">
									...
									<div class="item-img-mask">
										<a href="<?php echo $item->authorLink;?>" title="<?php echo $item->categoryname ?>">
											+
										</a>
									</div>
                                </div>
