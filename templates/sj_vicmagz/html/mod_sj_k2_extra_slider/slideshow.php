...
//    $currency = CurrencyDisplay::getInstance();
    ...
    <div class="moduletable <?php echo $class_suffix; ?>">
        ...
        <div id="<?php echo $tag_id;?>"
             class="sj-extra-slider slideshow msie lt-ie9 <?php echo $cls_btn_page; ?> <?php echo $class_respl; ?> <?php echo $btn_type; ?>" ><![endif]-->
        <!--[if IE 9]>
        <div id="<?php echo $tag_id;?>"
             class="sj-extra-slider slideshow msie <?php echo $cls_btn_page; ?> <?php echo $class_respl; ?> <?php echo $btn_type; ?>"><![endif]-->
        <!--[if gt IE 9]><!-->
        <div id="<?php echo $tag_id ; ?>"
             class="sj-extra-slider slideshow <?php echo $cls_btn_page; ?> <?php echo $class_respl; ?>  <?php echo $btn_type; ?>"><!--<![endif]-->
                ...
                <?php  foreach ($list as $item) {
                    ...
                    <div class="item-wrap <?php echo $items_style; ?>">
                        <div class="item-wrap-inner">
                            ...
                            <?php if( $options->item_title_display == 1 || $options->item_desc_display == 1 || ( $item->tags != '') || $options->item_readmore_display == 1 || $item->categoryname ){ ?>
                                <div class="item-info">
									<?php if($item->categoryname){ ?>
										<div class="item-category">
											<a class="btn btn-color" href="<?php echo $item->authorLink;?>" title="<?php echo $item->categoryname ?>">
									...
									<ul class="item-footer">
										...
										<li class="itemAuthor">
											...
											<a href="<?php echo $item->authorLink ?>">
