...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2RecentPosts k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
				...
				<div class="moduleItemImageBlock pull-left">
					<a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
						...
						if (!empty( $src)) {
							...
							$thumb_img = yt_placehold($placehold_size['xsmall'],$item->title,$item->title); 
						}
					   echo $thumb_img;
					   ?>
					</a>
				...
				<div class="media-body">
					<div class="moduleItemIntrotext">
						<?php if($params->get('itemCategory')): 
							...
							<div><a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><?php echo $string_cate; ?></a></div>
						<?php endif; ?>
						<?php if($params->get('itemTitle')): ?>
							<h4><a class="moduleItemTitle" href="<?php echo $item->link; ?>"><?php echo substr($item->title, 0, 25); ?></a></h4>
						<?php endif; ?>
