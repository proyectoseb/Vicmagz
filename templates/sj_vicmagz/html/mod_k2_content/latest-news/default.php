...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="grid latestNews k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<div class="items row">
		...
		<div class="col-sm-<?php echo($key+1) %3 == 0 ? '12 item-full' : 6; ?> item <?php if(count($items)==$key+1) echo ' lastItem'; ?>">
			<?php //var_dump(($key+1) %3)?>
			...
			<div class="moduleItemImageBlock">
				<a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
					...
					if (!empty( $src)) {
						...
						$thumb_img = yt_placehold($placehold_size['large'],$item->title,$item->title);
						//var_dump( $thumb_img);
					}	
					echo $thumb_img;
					?>
