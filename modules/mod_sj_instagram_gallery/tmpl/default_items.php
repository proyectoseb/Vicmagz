        ...
        <?php }
            ...
            <?php } ?>
                <div class="instagram_users">
                    <div class="img_users">
                        <a title="<?php echo $json_output['data'][$i]['user']['full_name'] ;?>" data-target="<?php echo $target ;?>" data-href="<?php echo $json_output['data'][$i]['link']?>" class="instagram_gallery_image gallery_image_<?php echo $module->id ;?>" rel="next" href="<?php echo $json_output['data'][$i]['images']['low_resolution']['url'] ?>?taken-by=<?php echo $json_output['data'][$i]['user']['username'] ?>">
